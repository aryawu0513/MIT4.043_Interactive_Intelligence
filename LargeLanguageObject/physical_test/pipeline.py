...
if __name__ == "__main__":
    ...
    #i have a day_dict and i want to only append it's emotion_value and rgb, with time_value being 6
    data.append({'emotion_value': day_dict['emotion_value'], 'time_value': 6, 'rgb': day_dict['emotion_rgb']})
